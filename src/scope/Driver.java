...
public class Driver {
	...
	public Driver(){
		...
		while (! directory.isGoodValid(userId)){
	...
	void displayNumberOfEmployees() {
		...
		int numEmployee = directory.getNumberOfBookstoreEmployees();
		System.out.println("Number of employees is: " + numEmployee + " (Look for other console messages.)"+line+CONTINUE);
	}
